class Cambios{
    ...
    if(elemento.innerHTML==""){
     cad="<section><h2>Ayuda de comandos</h2><h3>Los comandos que se pueden utilizar son los siguientes: </h3>";
            ...
            cad += "<li><b>Triángulo</b>: para poder dibujar un triangulo se necesita el ancho de la figura. Solo se dibujan cuadrados equilateros; y la forma de dibujar un triángulo por voz es con el comando 'dibujar cuadrado' </li>"; 
